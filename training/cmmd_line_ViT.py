...
python cmmd_line_ViT.py --data_root "C:/Users/Jimmy/OneDrive/Desktop/test/DS6050_Ai_Detection" --batch_size 32 --num_epochs 1 --learning_rate 3e-5 --train_percent 0.1 --num_workers 0 --model_name "ViT"
